...
public class ProductControllerTest {
    ...
    @SneakyThrows
    @Test
    public void validaFiltroDescricao_deveRetornarPageProdutosFiltrados_quandoComFiltroDesc() {
        mvc.perform(get(URL_PRODUTOS + "search")
                .accept(MediaType.APPLICATION_JSON)
                .param("page", "0")
                .param("size", "10")
                ...
                .andExpect(jsonPath("$.content[0].id", is(300)));
    }

    @SneakyThrows
    @Test
    public void validaFiltroNome_deveRetornarPageProdutosFiltrados_quandoComFiltroDesc() {
        mvc.perform(get(URL_PRODUTOS + "search")
                .accept(MediaType.APPLICATION_JSON)
                .param("page", "0")
                .param("size", "10")
    ...
    @SneakyThrows
    @Test
    public void validaFiltroEntrePrecos_deveRetornarPageProdutosFiltrados_quandoComFiltroDesc() {
        mvc.perform(get(URL_PRODUTOS + "search")
                .accept(MediaType.APPLICATION_JSON)
                .param("page", "0")
                .param("size", "10")
